...
// Strings
#define STR_MAXPWAD                                                            \
    "Too many files loaded! Not all files were added to the list."
#define STR_NOITEMS                                                            \
    "You must have at least 1 port and IWAD defined and available\n\nSelect "  \
    "ZDL -> Options to configure ports and IWADS"
#define STR_NEEDPRT                                                            \
    "This save specifies the port \"%s\" which is unavailable.\nDo you want "  \
    "to use \"%s\" instead?"
#define STR_NEEDIWD                                                            \
    "This save specifies the IWAD \"%s\" which is unavailable.\nDo you want "  \
    "to use \"%s\" instead?"
